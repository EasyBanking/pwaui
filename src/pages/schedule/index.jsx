  ...
  useEffect(() => 
    ...
    <Layout>
      <div className="mt-4">
          ...
          actions={[
            ...
            },
            {
              ...
              handler: (item) => {
                ...
                setschedules(schedules.filter( (schedule) => schedule.UserId != item.UserId))
          ...
          data={
            schedules.filter( (sched) =>{
              console.log(searchFilter)
                ...
                else if(JSON.stringify(sched).toLowerCase().includes(searchFilter.toLowerCase()))
        ...
        // "Priority": "5"
                UserId: <Link key ={key} to="/locations">{sched.UserId._id}</Link>,
